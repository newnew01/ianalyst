...
@section('content')
    <div class="box box-warning">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form role="form" method="post" action="/admin/textile/add">
                <!-- text input -->
                <div class="form-group">
                    <label>ชื่อผ้า</label>
                    <input name="textile-name" type="text" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="textile-detail" id="textile-detail" class="form-control" rows="13"></textarea>
                </div>
